...
async function testMentalHealthSearch() {
  try {
    ...
    // Test the search prospects API directly
    ...
    // Analyze the results
    const results = searchResponse.data.data || searchResponse.data.results || [];
    console.log('\n📊 SEARCH RESULTS ANALYSIS:');
    console.log('========================');
    console.log(`Total results: ${results.length}`);
    console.log(`Job ID: ${searchResponse.data.jobId || 'N/A'}\n`);
