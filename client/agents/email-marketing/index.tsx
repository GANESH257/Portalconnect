...
import { ArrowLeft, Mail, BarChart3, Target, Star } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-28 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="w-32 h-32 mx-auto mb-6 relative">
            <img
              src="/client/agents/Icons/Agent_EM.png"
              alt="Email Marketing Agent"
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Your automated email marketing specialist, creating personalized campaigns with performance tracking.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Mail className="w-12 h-12 text-theme-blue-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Automated Campaigns</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Create and manage email campaigns automatically with AI-powered optimization.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Target className="w-12 h-12 text-theme-yellow-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Personalization</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Deliver personalized content to each subscriber based on their preferences and behavior.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <BarChart3 className="w-12 h-12 text-theme-pink mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Performance Tracking</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Monitor campaign performance with detailed analytics and insights.</p>
          </div>
        </div>
        ...
        <div className="text-center bg-white/95 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
          ...
          <p className="text-theme-dark-blue/80 font-lato text-lg mb-8">
            We're building the ultimate email marketing AI agent to boost your campaign performance. 
