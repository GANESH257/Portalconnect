...
import { ArrowLeft, Search, TrendingUp, Target, Star } from "lucide-react";
import { Link } from "react-router-dom";

export default function SEOSpecialistAgent() {
  return (
    <div 
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-28 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="w-32 h-32 mx-auto mb-6 relative">
            <img
              src="/client/agents/Icons/Agent_SS.png"
              alt="SEO Specialist Agent"
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Your search optimization expert, enhancing digital visibility and driving organic traffic growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Search className="w-12 h-12 text-theme-blue-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Keyword Research</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Discover high-value keywords and optimize your content for search engines.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <TrendingUp className="w-12 h-12 text-theme-yellow-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Rank Tracking</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Monitor your search rankings and track performance improvements over time.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Target className="w-12 h-12 text-theme-pink mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Technical SEO</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Optimize technical aspects of your website for better search visibility.</p>
          </div>
        </div>
        ...
        <div className="text-center bg-white/95 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
          ...
          <p className="text-theme-dark-blue/80 font-lato text-lg mb-8">
            We're optimizing the perfect SEO specialist AI agent to boost your search rankings. 
