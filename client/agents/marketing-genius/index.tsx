...
import { ArrowLeft, Brain, TrendingUp, Target, Star } from "lucide-react";
import { Link } from "react-router-dom";

export default function MarketingGeniusAgent() {
  return (
    <div 
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-28 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-alata font-normal text-white mb-4 drop-shadow-lg">
            Marketing Genius Agent
          </h1>
          <p className="text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Your strategic marketing mastermind, providing insights and optimizing campaigns for maximum ROI.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Brain className="w-12 h-12 text-theme-blue-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Strategic Insights</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Get data-driven marketing strategies tailored to your business goals.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <TrendingUp className="w-12 h-12 text-theme-yellow-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Campaign Optimization</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Continuously optimize your marketing campaigns for better performance.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Target className="w-12 h-12 text-theme-pink mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">ROI Maximization</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Maximize your return on investment with intelligent budget allocation.</p>
          </div>
        </div>
        ...
        <div className="text-center bg-white/95 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
          ...
          <p className="text-theme-dark-blue/80 font-lato text-lg mb-8">
            We're developing the ultimate marketing intelligence AI agent to revolutionize your campaigns. 
