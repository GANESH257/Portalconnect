...
import { ArrowLeft, Code, Terminal, Wrench, Star } from "lucide-react";
import { Link } from "react-router-dom";

export default function CodingHelperAgent() {
  return (
    <div 
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-28 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="w-32 h-32 mx-auto mb-6 relative">
            <img
              src="/client/agents/Icons/Agent_SE.png"
              alt="Coding Helper Agent"
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Your technical development companion, assisting with code generation and problem-solving.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Code className="w-12 h-12 text-theme-blue-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Code Generation</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Generate clean, efficient code in multiple programming languages.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Terminal className="w-12 h-12 text-theme-yellow-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Debugging Help</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Identify and fix bugs with intelligent error analysis and solutions.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Wrench className="w-12 h-12 text-theme-pink mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Technical Support</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Get help with technical challenges and development best practices.</p>
          </div>
        </div>
        ...
        <div className="text-center bg-white/95 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
          ...
          <p className="text-theme-dark-blue/80 font-lato text-lg mb-8">
            We're coding the perfect development assistant AI agent to accelerate your programming journey. 
