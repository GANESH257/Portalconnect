...
import { ArrowLeft, PenTool, FileText, Sparkles, Star } from "lucide-react";
import { Link } from "react-router-dom";

export default function CopywriterAgent() {
  return (
    <div 
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-20 lg:py-28 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="w-32 h-32 mx-auto mb-6 relative">
            <img
              src="/client/agents/Icons/Agent_CW.png"
              alt="Copywriter Agent"
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto drop-shadow-md">
            Your creative writing companion, generating compelling content for marketing campaigns and brand messaging.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <PenTool className="w-12 h-12 text-theme-blue-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Creative Writing</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Generate engaging copy that captures your brand's voice and resonates with your audience.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <FileText className="w-12 h-12 text-theme-yellow-primary mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Content Variety</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Create everything from social media posts to long-form articles and marketing materials.</p>
          </div>
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <Sparkles className="w-12 h-12 text-theme-pink mb-4" />
            <h3 className="text-xl font-alata text-theme-dark-blue mb-2">Brand Voice</h3>
            <p className="text-theme-dark-blue/80 font-lato text-sm">Maintain consistent brand messaging across all content with AI-powered voice matching.</p>
          </div>
        </div>
        ...
        <div className="text-center bg-white/95 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
          ...
          <p className="text-theme-dark-blue/80 font-lato text-lg mb-8">
            We're crafting the perfect copywriting AI agent to help you create compelling content. 
